alert("Terimakasih, Selamat Datang di Kalku-latorz.");
...
if (user.language === "English") {
   ...
   alert("Hajimemashite, " + user.name.first + " " + user.name.last + "!");
    ...
    alert("Anyeonghaseyo, " + user.name.first + " " + user.name.last + "!");
} else if (user.language === "Jawa") {
    alert("Maturnuwun nggih, " + user.name.first + " " + user.name.last + "!");
} else {
